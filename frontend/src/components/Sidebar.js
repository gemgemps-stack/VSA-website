...
const MenuIcon = ({ name }) => {
  switch (name) {
    ...
    case 'finance':
      return (
        <svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
          <path d="M7.1 6.2c0-1.2 1-2.1 2.6-2.1 1.2 0 2.2.5 2.8 1.4" />
          <path d="M12.2 7.2c-.7-1-2-1.5-3.4-1.5-1.8 0-3.2 1-3.2 2.5 0 1.7 1.5 2.4 3.3 2.8l1 .2c1.9.4 3.4 1.1 3.4 2.8 0 1.7-1.6 2.9-3.7 2.9-1.7 0-3.1-.6-4-1.5" />
